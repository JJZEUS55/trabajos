...
{
public String bd="prueba1";
//En esta parte donde dice Lety-PC se cambia por el nombre host que tienes en workbench o la ip de la otra computadora es todo lo que tienes de cambiar en java
...
public String url="jdbc:mysql://Lety-PC:3306/"+bd;
