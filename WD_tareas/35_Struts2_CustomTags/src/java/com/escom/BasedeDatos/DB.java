package com.escom.BasedeDatos;

import java.io.*;
import java.sql.*;

//SERIALIZABLE EVITA QUE EL COLECTOR DE BASURA SE LLEVE LAS COSAS
public class DB implements java.io.Serializable {

    private String url;
    private String driver;
    //transient SE PONE POR QUE LAS CONECCIONES NO SON SERIALIZABLES
